    ...
    <>
      ...
      <div className="w-64 h-screen bg-card border-r border-border flex flex-col overflow-hidden">
        ...
        <div className="p-3 flex-shrink-0">
          <Button variant="outline" className="w-full justify-start gap-2 text-sm font-medium" onClick={handleNewChat}>
            <PlusCircle size={16} />
            New Thread
        ...
        <nav className="px-3 py-2 flex-shrink-0">
          <div className="space-y-1">
            <Link href="/" passHref>
              <Button
                variant="ghost"
                className={cn("w-full justify-start gap-2 text-sm font-medium", pathname === "/" && "bg-accent")}
              >
                <Home size={16} />
                Home
              </Button>
                  ...
                  <Link key={chat.id} href={`/search/${chat.id}`} passHref>
                    <Button
                      ...
                      className={cn(
                        ...
                        currentThreadId === chat.id && "bg-accent text-accent-foreground",
                      )}
                    >
