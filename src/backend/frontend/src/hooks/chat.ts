      ...
      try {
        ...
        const makeRequest = () => {
          return new Promise<void>((resolve, reject) => {
            ...
            console.log("Making streaming request directly to backend at:", `${BASE_URL}/chat`)
            
            // Connect directly to the backend service, bypassing Next.js API routes
            // This gives better streaming performance within Docker
